          ...
          <div class="card-body">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" name="categoria_pai_nome" class="form-control" class="form-control" value="<?php echo isset($master) ? $master->categoria_pai_nome :  set_value('categoria_pai_nome'); ?>">
              ...
              <?php if (isset($master)) : ?>
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" name="categoria_pai_meta_link" class="form-control" class="form-control border-0" value="<?php echo  $master->categoria_pai_meta_link; ?>" readonly>
                </div>
