          ...
          <div class="card-body">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <input type="text" name="marca_nome" class="form-control" class="form-control" value="<?php echo isset($marca) ? $marca->marca_nome :  set_value('nome_marca'); ?>">
              ...
              <?php if (isset($marca)) : ?>
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" name="marca_metalink" class="form-control" class="form-control border-0" value="<?php echo  $marca->marca_meta_link; ?>" readonly>
